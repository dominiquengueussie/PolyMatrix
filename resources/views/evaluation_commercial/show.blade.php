...
@section('content')
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('evaluations_commercials.index') }}">Evaluations commerciaux</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Statistiques des commerciaux</li>
        ...
        <table class="table table-hover table-striped table-bordered border border-3 text-center">
            <thead>
                <tr>
                    ...
                    <th scope="col">objectif smart</th>
                    <th scope="col">tactique execution </th>
                    <th scope="col">suivi des engagements </th>
            ...
            <tbody>
                @foreach ($evaluations as $evaluation)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('evaluations_commercials.destroy', $evaluation->id) }}" method="POST">
