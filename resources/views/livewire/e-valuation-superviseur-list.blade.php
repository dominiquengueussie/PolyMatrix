                            ...
                            <div class="container mt-5">
                                <div class="card">
                                    <div class="card-header bg-success text-light">
                                        <h2 class="fw-bolder">Evaluation d'un superviseur: <span class="fs-4">dérouler
                                                les listes puis attribuer une note de 1 à 4.</span></h2>
                                    </div>
                                    <div class="card-body py-5 px-md-5">
                                        <form action="{{ route('evaluations_superviseurs.store') }}" method="POST">
                                            @csrf
                                            <div class="row d-flex ">
                                                <div class="container">
                                                    ...
                                                    <select class="form-select border border-success fw-bolder"
                                                        name="nom_superviseur" id="nom">
                                                        @foreach ($users as $user)
                                                            <option value="{{ $user->nom }}">{{ $user->nom }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @if ($errors->has('nom_superviseur'))
                                                        <span style="font-size: 15px;"
                                                            class="text-danger">{{ $errors->first('nom_superviseur') }}
                                                        </span>
                                                    @endif
                                                </div>
                                                <div class="accordion mt-2" id="accordionExample">
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            &nbsp; <strong
                                                                class="mb-2 text-primary">Préparation.</strong>
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            aria-labelledby="headingOne"
                                                            data-bs-parent="#accordionExample">
                                                            &nbsp; <strong class="mb-2 text-primary">Environnement
                                                                et
                                                                style.</strong>
                                                            <div class="accordion-body">
                                                                <div class="form-check">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            aria-labelledby="headingOne"
                                                            data-bs-parent="#accordionExample">
                                                            &nbsp; <strong class="mb-2 text-primary">Le point sur les
                                                                outils.</strong>
                                                            <div class="accordion-body">
                                                                <div class="form-check">
                                                                    <input value="1" class="form-check-input"
                                                ...
                                                <div class="mt-4 row">
                                                    <div class="col-md-6 mt-2">
                                                        <label for="resultat" class="form-label">Résultat
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" required
                                                           name="resultat" class="form-control border border-success" id="resultat">

                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label for="condition" class="form-label">Condition
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text"
                                                          name="condition"  class="form-control border border-success" id="condition">
                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label for="tour_1" class="form-label">Tour 1
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" required
                                                          name="tour_1"  class="form-control border border-success" id="tour_1">

                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label for="tour_2" class="form-label">Tour 2
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text"  required
                                                          name="tour_2"  class="form-control border border-success" id="tour_2">
                                                    </div>
                                                    <div class="form-floating mt-2">
                                                        <textarea style="height: 200px;" cols="500" class="form-control border border-success"
                                                        required  name="resume"  placeholder="Insérer votre résumé ici" id="floatingTextarea"></textarea>
